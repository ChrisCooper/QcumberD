...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Career.last_encountered'
        db.delete_column('course_catalog_career', 'last_encountered')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Career.last_encountered'
        raise RuntimeError("Cannot reverse this migration. 'Career.last_encountered' and its values cannot be restored.")
