...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Career'
        db.create_table('course_catalog_career', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('last_encountered', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('course_catalog', ['Career'])

        # Adding field 'Course.units'
        db.add_column('course_catalog_course', 'units',
                      self.gf('django.db.models.fields.DecimalField')(default='-1', max_digits=3, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Career'
        db.delete_table('course_catalog_career')

        # Deleting field 'Course.units'
        db.delete_column('course_catalog_course', 'units')
