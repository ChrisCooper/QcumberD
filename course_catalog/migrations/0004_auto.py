...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field instructors on 'SectionComponent'
        db.create_table('course_catalog_sectioncomponent_instructors', (
        ...
        db.create_unique('course_catalog_sectioncomponent_instructors', ['sectioncomponent_id', 'instructor_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field instructors on 'SectionComponent'
        db.delete_table('course_catalog_sectioncomponent_instructors')
