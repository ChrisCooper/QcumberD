...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('course_catalog_course', 'prereqs')

        # Adding field 'Course.enrollment_reqs'
        db.add_column('course_catalog_course', 'enrollment_reqs',
    ...
    def backwards(self, orm):
        ...
        db.add_column('course_catalog_course', 'prereqs',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Deleting field 'Course.enrollment_reqs'
        db.delete_column('course_catalog_course', 'enrollment_reqs')
