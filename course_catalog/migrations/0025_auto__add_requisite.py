...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('course_catalog_requisite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('last_encountered', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('subject_abbr', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('course_number', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('left_index', self.gf('django.db.models.fields.IntegerField')()),
            ('right_index', self.gf('django.db.models.fields.IntegerField')()),
            ('for_course', self.gf('django.db.models.fields.related.ForeignKey')(related_name='requisites', null=True, to=orm['course_catalog.Course'])),
        ))
        db.send_create_signal('course_catalog', ['Requisite'])


    def backwards(self, orm):
        # Deleting model 'Requisite'
        db.delete_table('course_catalog_requisite')
    ...
    models = {
        ...
        'course_catalog.requisite': {
            'Meta': {'object_name': 'Requisite'},
            'course_number': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'for_course': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'requisites'", 'null': 'True', 'to': "orm['course_catalog.Course']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_encountered': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
