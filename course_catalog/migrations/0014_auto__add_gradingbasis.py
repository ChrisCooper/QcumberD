...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GradingBasis'
        db.create_table('course_catalog_gradingbasis', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('last_encountered', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('course_catalog', ['GradingBasis'])


    def backwards(self, orm):
        # Deleting model 'GradingBasis'
        db.delete_table('course_catalog_gradingbasis')
