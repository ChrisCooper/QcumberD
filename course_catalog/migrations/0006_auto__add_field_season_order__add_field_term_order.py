...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Season.order'
        db.add_column('course_catalog_season', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Term.order'
        db.add_column('course_catalog_term', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Season.order'
        db.delete_column('course_catalog_season', 'order')

        # Deleting field 'Term.order'
        db.delete_column('course_catalog_term', 'order')
