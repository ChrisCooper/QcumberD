...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('course_catalog_course', 'career',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='courses', null=True, to=orm['course_catalog.Career']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.career'
        db.delete_column('course_catalog_course', 'career_id')
