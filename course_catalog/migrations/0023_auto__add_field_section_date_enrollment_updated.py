...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Section.date_enrollment_updated'
        db.add_column('course_catalog_section', 'date_enrollment_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Section.date_enrollment_updated'
        db.delete_column('course_catalog_section', 'date_enrollment_updated')
