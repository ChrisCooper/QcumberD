...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.grading_basis'
        db.add_column('course_catalog_course', 'grading_basis',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='courses', null=True, to=orm['course_catalog.GradingBasis']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.grading_basis'
        db.delete_column('course_catalog_course', 'grading_basis_id')
