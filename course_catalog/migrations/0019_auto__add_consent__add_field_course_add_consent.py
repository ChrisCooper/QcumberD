...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('course_catalog_course', 'add_consent',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='courses', null=True, to=orm['course_catalog.Consent']),
                      keep_default=False)
    ...
    models = {
        ...
        'course_catalog.course': {
            ...
            'add_consent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'courses'", 'null': 'True', 'to': "orm['course_catalog.Consent']"}),
