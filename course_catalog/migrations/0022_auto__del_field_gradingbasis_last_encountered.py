...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GradingBasis.last_encountered'
        db.delete_column('course_catalog_gradingbasis', 'last_encountered')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'GradingBasis.last_encountered'
        raise RuntimeError("Cannot reverse this migration. 'GradingBasis.last_encountered' and its values cannot be restored.")
