...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Career.title'
        db.delete_column('course_catalog_career', 'title')

        # Adding field 'Career.name'
        db.add_column('course_catalog_career', 'name',
                      self.gf('django.db.models.fields.CharField')(default='no name', max_length=50),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Career.title'
        raise RuntimeError("Cannot reverse this migration. 'Career.title' and its values cannot be restored.")
        # Deleting field 'Career.name'
        db.delete_column('course_catalog_career', 'name')
    ...
    models = {
        ...
        'course_catalog.course': {
            ...
            'units': ('django.db.models.fields.DecimalField', [], {'default': "'-1'", 'max_digits': '3', 'decimal_places': '2'})
        },
