...
Qcumber is a course catalog created for Queen's University. It lives at [Qcumber.ca](Qcumber.ca). The original source code is available under the terms of the Mozilla Public License, v. 2.0, available at http://mozilla.org/MPL/2.0/. Images and other non-code assets are &copy; 2012 Chris Cooper.
