...
Qcumber is a course catalog created for Queen's University. It is live at [Qcumber.ca](Qcumber.ca), and the main repository is at [ChrisCooper/QcumberD](https://github.com/ChrisCooper/QcumberD) on Github. Check out the [wiki](https://github.com/ChrisCooper/QcumberD/wiki) for extra information not in this readme.
