...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SectionType.order'
        db.add_column('course_catalog_sectiontype', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SectionType.order'
        db.delete_column('course_catalog_sectiontype', 'order')
